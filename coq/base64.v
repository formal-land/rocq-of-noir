...
Definition test_decode_multi_chunks₀ (α : list Value.t) : M.t Value.t :=
  match α with
  | [] =>
    [[
      let input :=
...
Definition base64_decode₁ (α : list Value.t) : M.t Value.t :=
  match α with
  | [input] =>
    [[
      let decoded :=
        ...
        Binary.add (|
          ...
          M.cast (|
            Binary.not_equal (|
              ...
              Value.Integer 0
            |),
            Ty.Integer Ty.Signedness.Unsigned ThirtyTwo
          |)
        |) in
      M.if_ (|
        Binary.greater (|
...
Definition eq₂ (α : list Value.t) : M.t Value.t :=
  match α with
  | [self, other] =>
    [[
      let result :=
...
Definition base64_decode_elements₃ (α : list Value.t) : M.t Value.t :=
  match α with
  | [input] =>
    [[
      let Base64Decoder :=
        ...
        [[
          ...
          M.assert (|
            Binary.not_equal (|
              ...
              Value.Integer 255
            |),
            Some Value.fmt_str DecodeError: invalid symbol {input_byte}, offset {i}. 2 Tuple [input_byte, i]
          |)
        ]]
      |)
      result
...
Definition to_be_bytes₄ (α : list Value.t) : M.t Value.t :=
  match α with
  | [self] =>
    [[
      let bytes :=
...
Definition new₆ (α : list Value.t) : M.t Value.t :=
  match α with
  | [] =>
    [[
      [[
...
Definition get₇ (α : list Value.t) : M.t Value.t :=
  match α with
  | [self, idx] =>
    [[
      M.index (|
        ExtractTupleField self 0,
        idx
      |)
    ]]
  | _ => M.impossible "wrong number of arguments"
...
Definition to_be_radix₈ (α : list Value.t) : M.t Value.t :=
  match α with
  | [self, radix] =>
    [[
      Semi M.call_closure (|
